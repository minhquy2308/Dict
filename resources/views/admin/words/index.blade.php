...
@section('content')
	<div class="row">
		...
		<div class="col-md-3">
			<a href="{{ route('words.create')}}" class="btn btn-sm btn-block btn-primary">Thêm từ mới</a>
			<a href="{{ route('words.check')}}" class="btn btn-sm btn-block btn-primary">Duyệt từ</a>
		</div>
		<div class="col-md-12">
			<hr>
		</div>
